...
public class ServidorChess extends Thread {
	...
	public static void main(String[] a) {
		ServidorChess s = new ServidorChess(999);
		s.start();
	}
	...
	private String removeAgain(String texto) {
		String saida = "";
		int p = texto.lastIndexOf("[Again]");
		if (p >= 0) {
			saida = texto.substring(0, p) + texto.substring(p + 7);
		}
		return saida;
	}
